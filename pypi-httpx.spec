...
Source0  : https://files.pythonhosted.org/packages/f1/f6/498232c83e01b11ab45b1bd918f9d92d136e45e4a6103e759ffa6ff8d92d/httpx-0.23.2.tar.gz
...
%prep
%setup -q -n httpx-0.23.2
cd %{_builddir}/httpx-0.23.2
pushd ..
cp -a httpx-0.23.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672688396
