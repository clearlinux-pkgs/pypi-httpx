...
Source0  : https://files.pythonhosted.org/packages/f5/50/04d5e8ee398a10c767a341a25f59ff8711ae3adf0143c7f8b45fc560d72d/httpx-0.23.3.tar.gz
...
%prep
%setup -q -n httpx-0.23.3
cd %{_builddir}/httpx-0.23.3
pushd ..
cp -a httpx-0.23.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672849776
