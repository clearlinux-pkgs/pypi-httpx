...
Source0  : https://files.pythonhosted.org/packages/59/07/de30dd4bb26131bf34fe82bf721a392ff21e35bb2707ef8cbec954054a23/httpx-0.22.0.tar.gz
...
%prep
%setup -q -n httpx-0.22.0
cd %{_builddir}/httpx-0.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649760487
...
cp %{_builddir}/httpx-0.22.0/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-httpx/2f9a422e6ae22185bd3e9cdaec727ac95ab47bbb
